 ...
 * Rows are containers for divs, as the rows are resized, the div content will also be resized to fit.
 */
class Grid{
    /**
     * The Grid class takes in the window width and height, passed in to establish a basic window size. The default grid has no rows or collumns within it. To add content call the {@link Grid#createColumn} method.
     * @param {Number} width - This is the width of the grid.
     * @param {Number} height - This is the height of the grid.
     ...
     * @property {Function} createVDrag             - A function to add a Vertical Drag to this column, the vertical drag will enable rows to be resized dynamically.
     * @property {Array}    callbacks               - An array of callback functions to be executed when this column is resized.
     * @property {Function} executeElementsCallback - This is the function which is executed whenever this column is resized, it then in part executes all of the functions defined in the callback array.
     * @property {Function} registerCallback        - This function is called to register interest in a specific row. A callback function is also passed, this callback will be executed when that specific element is resized.
     */
     ...
     * @param {Object} properties - These are additional configuration paramiters that can be passed into a column.
